...
Malte är nöjd. Det är vi också.`,
    ...
    },
    {
        ...
        category: 'Tandvård',
        city: 'Linköping',
        shortDescription: 'Ett designkoncept som visar hur en tandkliniks sajt kan göra det enkelt för nya patienter att ta kontakt.',
        ...
        heroImage: '/images/case-leendekliniken.jpg',
        featured: true,
        accent: 'cyan',
        caseType: 'concept',
    },
    {
        ...
        city: 'Linköping',
        shortDescription: 'Ett designkoncept som visar hur ett café kan synas lokalt och göra det enkelt för gäster att hitta och boka bord.',
        ...
        heroImage: '/images/case-cafe-alma.jpg',
        featured: true,
        accent: 'amber',
        caseType: 'concept',
    },
    {
        ...
        city: 'Linköping',
        shortDescription: 'Ett designkoncept som visar hur en elfirmas sajt kan göra det enkelt för nya kunder att ta kontakt.',
